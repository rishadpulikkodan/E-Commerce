...
<br/>
<p align="center" class="h4">Posts | <a href="<?= base_url()?>index.php/back/addpost"><i class="material-icons">&#xe146;</i> Add post</a></p>
    ...
    <thead class='thead-dark'>
      <?php if($rows){ ?>
        <tr>
            ...
            <th scope='col'>filename <i class="ricon material-icons">&#xe264;</i></th>
        ...
        <tr id="row<?=$r->id?>" style="transition:1s;">
            <td><?=$r->id?></td>
            <td><img class="mimg" style="width:30px;transition:0.5s;" src="<?php echo base_url()."res/posts/".$r->filename;?>" /></td>
            <td><?=$r->filename?></td>
            <td>
...
<script type="text/javascript">
    function removealert(id){
            ...
            $.ajax("<?=base_url()?>index.php/back/postremovealert/"+id)
    ...
    function remove(id){
            ...
            $.ajax("<?=base_url()?>index.php/back/removepost/"+id)
