...
<br/>
  <form onsubmit="
      ...
      " class="form-horizontal" action="<?= base_url()?>index.php/back/catogeryedit/<?=$id?>" method="POST" enctype='multipart/form-data' style="
      opacity: 100%;
      filter: blur(0px);
      transition:5s;
      padding: 10px;
  ...
  <h5 align="center">Edit catogery name</h5>
  <br/>
  <div class="form-group row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-8 col-xl-8">
      <input id="name" name="name" placeholder="Catogery name" class="form-control input-md" required="" type="text" value="<?=$row->name?>">
    </div>
  </div>
