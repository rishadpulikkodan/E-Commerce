...
<form onsubmit="
    ...
    " class="form-horizontal" action="<?=base_url()?>index.php/back/addtostock" method="POST" enctype='multipart/form-data' style="
    opacity: 100%;
    filter: blur(0px);
    transition:5s;
    padding: 10px;
...
<h5 align="center">Add to stock</h5>
<br/>
<div class="form-group row">
  <label class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 control-label col-form-label" for="name" autofocus >Product name</label>
  <div class="col-xs-12 col-sm-12 col-md-6 col-lg-8 col-xl-8">
    <input id="name" name="name" placeholder="Product name" class="form-control input-md" required="" type="text" autofocus="autofocus" />
  </div>
</div>
...
<div class="form-group row">
  ...
  <div class="col-xs-12 col-sm-12 col-md-6 col-lg-8 col-xl-8">                     
    <textarea class="form-control input-md" id="description" name="info" placeholder="description"></textarea>
  </div>
</div>
...
<div class="form-group row">
  <label class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 control-label col-form-label" for="image">Main image (thumb)</label>
  <div class="input-group col-xs-12 col-sm-12 col-md-6 col-lg-8 col-xl-8">
    <div class="input-group-prepend">
      <span class="input-group-text" id="inputGroupFileAddon01">Image</span>
    </div>
    <div class="custom-file">
      <input required="" type="file" class="custom-file-input" id="image" name="image" accept='image/png, image/jpeg' aria-describedby="image">
...
<div class="form-group row">
  <label class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 control-label col-form-label" for="photo">Gallery Images</label>
  <div class="input-group col-xs-12 col-sm-12 col-md-6 col-lg-8 col-xl-8">
    <div class="input-group-prepend">
      <span class="input-group-text" id="inputGroupFileAddon02">Photo</span>
    </div>
    <div class="custom-file">
      <input type="file" class="custom-file-input" id="photo" name="photo[]" accept='image/png, image/jpeg' multiple='multiple' aria-describedby="photo">
